    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surface', models.CharField(choices=[('Sintética', 'Sintética'), ('Pasto Natural', 'Pasto Natural'), ('Cemento', 'Cemento')], default='Sintética', max_length=16, verbose_name='Tipo de Superficie')),
